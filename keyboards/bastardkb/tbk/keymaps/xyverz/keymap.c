...
enum layer_names { _WINDOWS, _MAC, _WEIRDGAMES, _LOWER, _RAISE, _ADJUST };

enum custom_keycodes { WINDOWS = SAFE_RANGE, MAC, WGAMES, ADJUST };
...
[_WEIRDGAMES] = LAYOUT_split_4x6_5(
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS,
  KC_TAB,  KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,        KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_SLSH,
  KC_GRV,  KC_A,    KC_O,    KC_E,    KC_U,    KC_I,        KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_MINS,
  KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,        KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_RSFT,
                             LOWER,   KC_SPC,  KC_LGUI,     KC_ENT,  KC_SPC,  RAISE,
                                      KC_LCTL, KC_LALT,     KC_RGUI, KC_RCTL
  ),
...
[_ADJUST] = LAYOUT_split_4x6_5(
  ...
  _______, _______, _______, _______, _______, _______,     _______, WINDOWS, MAC,     WGAMES,  _______, _______,
  _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______,
    ...
    if (record->event.pressed) {
        switch (keycode) {
            ...
            case MAC:
                ...
                return false;
            case WGAMES:
                set_single_persistent_default_layer(_WEIRDGAMES);
                return false;
        }
    }
    return true;
